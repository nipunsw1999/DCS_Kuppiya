...
<div class="dwn">
    <div class="ctrl-main">
        ...
        <form action="postview.page.php" class="ctrl" method="post">
            <div class="ctrl-btn"><button type="submit" name="rm" onclick="return confirm('Are you sure?');"><i
        ...
        <?php
            ...
            ?>
        <form action="postview.page.php" class="ctrl" method="post">
            <div class="ctrl-btn"><button type="submit" name="back" onclick="return confirm('Are you sure?');"><i
