...
<div>
    ...
    <form class="fm" action="changeProfile.page.php" method="post" enctype="multipart/form-data">
        ...
        <div class="formm">
            ...
            <div>
                <button type="submit" name="submit1" onclick="return confirm('Are you sure?');">Update name</button>
            </div>
        </div>
        <div class="formm">
            ...
            <div>
                <button type="submit" name="submit2" onclick="return confirm('Are you sure?');">Update contact details</button>
            </div>
        </div>
        <div class="formm">
            ...
            <div>
                <button type="submit" name="submit3" onclick="return confirm('Are you sure?');">Update password</button>
            </div>
        </div>
        <div class="formm">
            <div>
            ...
            <div>
                <button type="submit" name="submit4" onclick="return confirm('Are you sure?');">Update profile picture</button>
            </div>
        </div>
    </form>
