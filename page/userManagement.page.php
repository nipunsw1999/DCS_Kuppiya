...
<div class="umpanel">
    <form action="userManagement.page.php" method="post" class="umpanel">
        ...
        <div class="umpanel-div">
            ...
            <div><button type="submit" name="rm-user-btn" onclick="return confirm('Are you sure?');">Remove user</button></div>
        </div>

        <div class="umpanel-div">
            <div><input type="text" name="rm-user-all" placeholder="Registration start with..."></div>
            <div><button type="submit" name="rm-user-all-btn" onclick="return confirm('Are you sure?');">Remove all</button></div>
        </div>
        <div class="goBack">
