    ...
    <div class="s-man0">
        <form action="subjectManagement.page.php" method="post" class="s-man">
            ...
            <div class="def-coz a-coz">
                ...
                <div><input type="text" name="year" placeholder="Course units effective from academic year"></div>
            ...
            <div class="def-coz d-coz">
                ...
                <div><button type="submit" name="d-coz" class="s-man-btn" onclick="return confirm('Are you sure?');">Delete course</button></div>
            </div>
...
alert('Course already exists');
                    ...
                    $sql = "INSERT INTO coz_details (cozid,cozname,cozlevel,year) VALUES ('$acozid','$acozname','$alevel','$year');";
                    $result = mysqli_query($con, $sql);
                    if ($result) {
                        echo "<script>
alert('Course added');
